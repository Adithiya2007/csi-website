...
export async function POST(req: NextRequest) {
  try {
    ...
    const context = "You are a helpful assistant for CSI Student Chapter, a college tech club with 240+ members, 38 events, 52 projects and 12 hackathon wins. The club hosts hackathons, workshops and tech talks. Core team: Priyanka (President), Tharun (Vice President), Keerthana (Design Lead). Answer in 2-3 sentences max. Be friendly.";
